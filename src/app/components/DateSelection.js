...
export default function DateSelection() {
  ...
  <div className="relative flex-1">
    ...
    {/* menu */}
    <Menu.Items className="drodown-menu shadow-lg absolute -top-96 xl:top-[90px]
    left-1/2 xl:left-0 z-50 transform -translate-x-1/2 xl:-translate-x-0 rounded-
