...
export default function Header() {
  ...
  return (
    ...
    >
      <div
        className="xl:container mx-auto flex flex-col xl:flex-row
      ...
      >
        ...
        xl:font-medium xl:flex-row xl:w-max xl:gap-x-8 xl:h-max 
        xl:bg-transparent xl:pb-0 transition-all 
        duration-150 text-center xl:text-left uppercase 
